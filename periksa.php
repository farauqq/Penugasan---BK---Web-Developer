...
if (isset($_POST['simpanData'])) {
    ...
    echo "
        <script> 
            alert('Terima kasih atas kunjungan anda, semoga lekas sembuh.');
        ...
        <div class="row">
            ...
            <form action="" method="POST">
                    ...
                    <div class="dropdown mb-3 ">
                        ...
                        <button style="margin-top: 0.5rem" id="addObat" type="button" class="btn btn-primary">Add Obat</button>
                    </div>
                        ...
                        document.getElementById('addObat').addEventListener('click', function() {
                            var obatDropdown = `
                                <div class="dropdown mb-3 w-25">
                                    ...
                                    <button style="margin-top: 0.5rem" type="button" class="btn btn-danger deleteObat">Delete Obat</button>
                                </div>
                            `;
